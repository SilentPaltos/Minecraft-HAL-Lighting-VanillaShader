...
It might be not perfect but I just wanted to create some lighting system using minecraft vanilla shaders. It affects blocks, entities and particles, but it is also unfinished sinc not all object are affected by this system. Probably I'll fix it.
...
It has 3 main files:
- `hal_structs.glsl` - just custom variable types but also you can open it defines light modes
...
`LIGHT_AREAS_COUNT` - defines how many areas are can be created for 1 color
